    ...
    <div className={styles.rootContainer}>
      <RootLayout showNavbar={true}>
        ...
        <div className="d-flex justify-content-center align-items-center flex-grow-1">
          ...
          <div className={`col-md-4 col-lg-4 mt-3 text-white text-center ${styles.editServiceHome}`}>
              <div className="rounded-circle overflow-hidden d-flex justify-content-center align-items-center mx-auto mb-3" style={{ width: "120px", height: "120px" }}>
                <Image
                  src={hiring}
                  alt='..'
                  width={120}
              ...
              <span className='text-xl md:text-l lg:text-xl xl:text-2xl 2xl:text-2xl font-medium'>Hiring</span>
              <a href="/hiring" className={`mt-3 p-2 text-l md:text-l lg:text-l xl:text-xl 2xl:text-xl font-semibold text-black ${styles.tryButton}`}>Try it now</a>
            </div>
            <div className={`col-md-4 col-lg-4 mt-3 text-white text-center ${styles.editServiceHome}`}>
              <div className="rounded-circle overflow-hidden d-flex justify-content-center align-items-center mx-auto mb-3" style={{ width: "120px", height: "120px" }}>
                <Image
              ...
              <span className='text-xl md:text-l lg:text-xl xl:text-2xl 2xl:text-2xl font-medium'>Ranking</span>
              <a href="/rankingnanny" className={`mt-3 p-2 text-l md:text-l lg:text-l xl:text-xl 2xl:text-xl font-semibold text-black ${styles.tryButton}`}>Try it now</a>
            </div>
            <div className={`col-md-4 col-lg-4 mt-3 text-white text-center ${styles.editServiceHome}`}>
              <div className="rounded-circle overflow-hidden d-flex justify-content-center align-items-center mx-auto mb-3" style={{ width: "120px", height: "120px" }}>
                <Image
              ...
              <span className='text-xl md:text-l lg:text-xl xl:text-2xl 2xl:text-2xl font-medium'>Activities</span>
              <a href="/pre-activityprogram" className={`mt-3 p-2 text-l md:text-l lg:text-l xl:text-xl 2xl:text-xl font-semibold text-black ${styles.tryButton}`}>Try it now</a>
            </div>
          </div>
        </div>
