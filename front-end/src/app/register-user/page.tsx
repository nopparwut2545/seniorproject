          ...
          <div className={`p-4 m-10 rounded-2xl ${styles.borderBox}`}>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col lg:grid lg:grid-cols-2 gap-2 text-center items-center">
              ...
              <div className="mt-10 locationAll">
                <label style={{ fontFamily: 'Comfortaa' }} className="block text-start text-black mb-2 text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-sm font-semibold">Location All</label>
                <input
                  type="text"
                  name="location_all"
